...
information <- tribble(
  ...
  "determine_indextypology", 0, 0, 0, 0.5, "data_indextypology.csv",
  "var_in_interval", 1, -2, 0, 0.5, "",
  "calculate_metric", 0, -4, 0, 0.5, "indextypology_metric.csv",
  ...
  "calculate_metric_measures.csv, extdata/data_taxonmetrics.csv",
