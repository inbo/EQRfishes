...
The overview in the different chapters of this report presents all these calculations, with chapter titles indicating the indextypologies, 2nd level titles the metrics that are needed to calculate the IBI and EQR, and the lower levels the calculations of the variables that are needed to calculate the higher level metric.
...
For the estuarien zonations of IJzer and Schelde, no standardisation is done.
