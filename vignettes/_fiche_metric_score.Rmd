...
This score is deduced as shown in the table (the calculation of the variables is explained above).
...
if (nrow(table_metric_score) < 1) {
  stop(
    "ERROR in fiche_metric_score.Rmd: score table will not be printed correctly"
  )
}
```
