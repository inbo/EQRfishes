...
The below overview presents all these calculations, with main titles indicating the zonations, 2nd level titles the metrics that are needed to calculate the IBI and EQR, and the lower levels the calculations of the variables that are needed to calculate the higher level metric.
