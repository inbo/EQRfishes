...
For zonation estuarien_IJzer, no standardisation is done.
...
Finally the EQR is calculated for the older indexes and the canals and IJzer estuaria as

$(EQR_{class} - 1) / nclass + (IBI_{std} - ibi_{classmin}) / (nclass * (IBI_{classmax} - IBI_{classmin}))$

and the EQR is the same as the standardised IBI for the newer indexes except for the canals.
